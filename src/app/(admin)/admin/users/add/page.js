  ...
  return (
    ...
    <div className='admin-user-add'>
      <div className='admin-users-add-basicInformation'>
        {addusers.map((addusers, index) => (
          ...
          >
              ...
              >
                <TextField fullWidth id="fullWidth" sx={{background:'#EEE'}} />
              </Box>
          </Stack>
        ))}
      </div>
      ...
      <div className='admin-users-add-other'>
        <Stack direction="row" display="flex" gap="10.1rem" marginBottom="2rem">
        <Stack
          className='input-col'
          sx={{
            textAlign: "start",
        ...
        >
          ...
          >
            <TextField id="outlined-basic" label="Ngày" variant="outlined" sx={{background:'#EEE'}} />
            <TextField id="filled-basic" label="Tháng" variant="outlined" sx={{background:'#EEE'}} />
            <TextField id="filled-basic" label="Năm" variant="outlined" sx={{background:'#EEE'}} />
          </Box>
        </Stack>

        <Stack spacing='4.9rem' direction="row" marginTop='7rem' justifyContent='flex-end'>
