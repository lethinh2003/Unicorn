...
const PRODUCTS_CART = [
    {
        ...
        product_image: "https://tse2.mm.bing.net/th?id=OIP.jvlty0y7lA8IR-8vKV57ygHaJQ&pid=Api&P=0&h=220"
    },
    {
        product_id: "2",
        product_name: "Áo thun tay ngắn nam",
        ...
        if (value <= 0 && value !== '') {
            newProducts.forEach((item) => {
                if (item.product_id === product_id) {
                    setProducts(newProducts.filter(item => item.product_id !== product_id));
                }
            }
            )
        } else {
            ...
            <div className='cart-container'>
                <div className='cart-left-panel'>
                    <div className='cart-left-panel-header'>
                        ...
                        <div className='cart-left-panel-quantity'>{products.length} sản phẩm</div>
                    </div>
                            ...
                            products.length === 0 ? (
                                <div className='cart-empty'>
                                    ...
                                    <Button sx={{
                                        ...
                                        onClick={() => Router.push('/')}>Mua ngay</Button>
                                </div>
                            ) : (
                                <TableContainer sx={{
                                    overflowY: 'scroll',
                                    ...
                                    <Table>
                                        <TableHead>
                                            <TableRow sx={{
                                                ...
                                                <TableCell align='center' sx={{ width: '15rem' }}>Tổng</TableCell>
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
                                            {
                                                        ...
                                                        <TableRow key={item.product_id}>
                                                            <TableCell>
                                                                <Stack direction='row' spacing={2}>
                                                                    <img src={item.product_image} style={{ width: '10rem', height: '10rem', objectFit: 'fill' }} />
                                                                    <Stack spacing={3}>
                                                                        <span style={{ fontSize: '1.5rem', fontWeight: 600 }}>{item.product_name}</span>
                                                                        <span style={{ fontSize: '1.3rem' }}>Màu: {item.product_color}</span>
                                                                        <span style={{ fontSize: '1.3rem' }}>Kích thước: {item.product_size}</span>
                                                                    </Stack>
                                                                </Stack>
                                                            </TableCell>
                                                            <TableCell align='center'>
                                                                <div style={{ display: 'flex', justifyContent: 'center' }}>
                                                                    <Button sx={{
                                                                        ...
                                                                        onClick={() => handleDecrease(item.product_id)}>-</Button>
                                                                    <input
                                                                        type='number'
                                                                        onChange={(e) => handleChangeQuantity(e.target.value, item.product_id)}
                                                                    ...
                                                                    <Button sx={{
                                                                        ...
                                                                        onClick={() => handleIncrease(item.product_id)}>+</Button>
                                                                </div>
                                                            </TableCell>
                                                            <TableCell align='center' sx={{ width: '10rem' }}>{item.product_price.toLocaleString('vi-VN')}đ</TableCell>
                                                            <TableCell align='center' sx={{ width: '15rem' }}>{(item.product_price * item.product_quantities).toLocaleString('vi-VN')}đ</TableCell>
                                                        </TableRow>
                                                    )
                                                })
                                            }
                ...
                <div className='cart-right-panel'>
                    <div className='cart-right-panel-header'>
                        <div className='cart-right-panel-title' style={{ color: '#fff' }}>Tổng đơn</div>
                    </div>
                    <div className='cart-right-panel-body' style={{
