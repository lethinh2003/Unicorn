    ...
    <Container sx={{ display: "block" }}>
      ...
      <Stack direction="row" spacing={2}>
          ...
          <Stack sx={{ backgroundColor: "#EEEEEE" }}>
            ...
            >
              ...
              >
                ...
                />
                <Typography sx={{ alignSelf: "center", display: "flex" }}>
                  Địa chỉ có sẵn
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                  ...
                  {addresses.map((address, index) => (
                    <div key={index} className="address-item">
                      ...
                      <div className="user-desc-value">
                        ...
                        <span className="user-desc-value-item">
                          {address.detail_address}, {address.district},{" "}
                          {address.ward}, {address.provine}
                        </span>
                        <span className="user-desc-value-item">
                          {address.phone}
                        </span>
        ...
        <Stack sx={{ width: "50%" }} spacing={2}>
          <Stack spacing={2} sx={{ backgroundColor: "#F7F7F7" }}>
            ...
            >
              {prodcutPayMent.map((item) => (
                <Link
                  href="#"
                  className="product-payment-producs-item"
                  key={item.product_id}
                >
                  <Stack
                    direction="row"
            ...
            <Stack spacing={2} sx={{ width: "100%" }}>
              ...
              >
                ...
                <Typography
                  variant="h5"
                  sx={{ fontWeight: 600, color: "#38AC8F" }}
                >
              ...
              >
                ...
                <Typography variant="h4">
                  {(totalPrices + deliveryFee + voucher).toLocaleString(
                    "vi-VN"
                  )}
                  đ
                </Typography>
          ...
          <Button sx={{ padding: "2rem", borderRadius: "1rem" }}>
            Thanh toán
          </Button>
        </Stack>
      </Stack>
