            ...
            <Container sx={{ height: '80rem', marginTop: '5%', marginBottom: '10%' }}>
                <Paper elevation={5}
                    ...
                    <Stack direction='row' sx={{
                        ...
                        <Stack spacing={5} sx={{ width: '100%', minWidth: '50rem', alignItems: 'center', alignSelf: 'flex-end' }}>
                            <Typography variant='h2' sx={{ fontWeight: '600' }}>SẢN PHẨM MỚI</Typography>
                            <Stack direction='row' spacing={2} sx={{ width: '100%', height: '100%', position: 'relative' }}>
                                <Box sx={{
                                    content: '""',
                                    height: '.5rem',
                                    width: '10rem',
                            ...
                            <Button sx={{
                                width: '30%', height: '5rem', color: '#f9f9f9', backgroundColor: '#000',
                                border: '.5rem solid #000',
                                borderRadius: '2.5rem',
                                '&:hover': {
                                    color: '#000', backgroundColor: '#f9f9f9',
                                }
                            }}>Xem thêm</Button>
                        </Stack>
                    </Stack>
